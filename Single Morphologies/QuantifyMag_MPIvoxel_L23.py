...
from example_suppl_2D import plot_cell, plot_mag_dist, plot_mag_dist_branch, plot_mag_voxel, find_tshow_global
...
for currdir in vector_str:
    ...
    fig.savefig('L23_LFPy(' + cellname + ')' + currdir + '.svg', dpi=350)
    ...
    f = open( 'L23_VAR_QuantifyMagDist(' + cellname + ')' + currdir + '.out', 'w')
